...
<div class="content-wrapper">
	...
	<section class="content">
		<div class="container-fluid">
					...
					<div class="timeline">
						...
						<?php foreach($dataBalas as $row) : ;?>
							<div>
								...
								<?php } ?>
								<div class="timeline-item">
									<span class="time"><i class="fas fa-clock"></i> <?= date("H:s",cetak($row['time'])); ?></span>
									<?php if($row['is_admin'] != 1) { ?>
			...
			<div class="row">
				<div class="col-md-12">
					<?= form_open('Ticket/lihat_ticket/'.cetak($token));?>
						...
						<div class="form-group clearfix mt-3">
							<a href="<?= base_url('Ticket'); ?>" class="btn btn-danger">Kembali</a>
			...
			<?php } ?>
			<?php if(cetak($statusTicket ==3)) { ?>
				<a href="<?= base_url('Ticket'); ?>" class="btn btn-danger"><i class="fas fa-chevron-circle-left"></i> Kembali</a>
			<?php } ?>
		</div>
	</section>
	<!-- /.content -->
