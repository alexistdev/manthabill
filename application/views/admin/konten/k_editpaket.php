...
<div class="content-wrapper">
	...
	<section class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1>Edit Paket <span class="text-primary font-weight-bold"></span></h1>
				</div>
				<div class="col-sm-6">
					...
					<div class="card">
						<div class="card-body">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										...
										<?= form_dropdown('tipePaket',$options,cetak($typeProduct),['class'=>'form-control','required'=>'required']); ?>
									</div>
								</div>
							</div>
							<!-- Harga Paket -->
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label for="hargaPaket">Harga Paket <span class="text-danger">*</span></label>
