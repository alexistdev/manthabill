  ...
  <div class="login-box-body">
	...
	<font color="green"><small><center><?php 
				 $pesan = $this->session->flashdata('item2');
					 echo $pesan['pesan'];
				 ?></center></small></font> 
    <form role="form" class="form-horizontal" action="<?php echo base_url('reset_password/done');?>" method="post">
		<div class="form-group has-feedback">
			<div class="col-md-12">
				<input type="password" name="password1"  required="required" class="form-control" placeholder="Password Baru">
				<span class="glyphicon glyphicon-envelope form-control-feedback"></span>
			</div>
		</div>
		<div class="form-group has-feedback">
			<div class="col-md-12">
				<input type="password" name="password2" required="required" class="form-control" placeholder="Ulangi Password Baru">
				<span class="glyphicon glyphicon-envelope form-control-feedback"></span>
			</div>
		</div>
	  <input type="hidden" name="token" required="required" class="form-control" value="<?php echo $token;?>">
      <div class="row">
        <!-- /.col -->
