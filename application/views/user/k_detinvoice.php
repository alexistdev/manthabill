    ...
    <section class="invoice">
      ...
      <div class="row invoice-info">
		...
		<?php 
									foreach($invoice->result_array() as $row):
										...
										$pajakInv = $row['pajak_inv'];
										$totalPajak = $totalInv*($pajakInv/100);
      ...
      <div class="row">
        ...
        <div class="col-xs-6">
          ...
          <p class="text-muted well well-sm no-shadow" style="margin-top: 10px;">
            Silahkan transfer ke rekening <strong>BTPN :123-456-789</strong><br>
        ...
        <div class="col-xs-6">
          ...
          <div class="table-responsive">
            <table class="table">
              ...
              <tr>
                <th>Pajak (<?php echo htmlentities($pajakInv." %", ENT_QUOTES, 'UTF-8');?>)</th>
                <td>Rp.&nbsp;<?php echo htmlentities(number_format($totalPajak,0,",","."), ENT_QUOTES, 'UTF-8');?>, -</td>
              </tr>
              <tr>
                <th>Total:</th>
                <td>Rp.&nbsp;<?php echo htmlentities(number_format($totalInv,0,",","."), ENT_QUOTES, 'UTF-8');?>, -</td>
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          ...
          <a href="<?php echo base_url('invoice/konfirmasi/'.htmlentities($idInv, ENT_QUOTES, 'UTF-8'));?>"<button type="button" class="btn btn-success pull-right"><i class="fa fa-credit-card"></i> Submit Payment
          </button></a>
