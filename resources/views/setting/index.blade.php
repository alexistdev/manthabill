                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                ...
                                <li class="list-group-item">
                                    <b>Status</b>
                                    <a class="float-end">Verified</a>
                                </li>
                            </ul>
                            <a href="{{ route('setting.password') }}" class="btn btn-info w-100">
                                <b>Ganti Password</b>
                            </a>
                        </div>
                    </div>
                            ...
                            <form action="{{ route('setting.update') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label">Alamat Kolom 1 <span class="text-danger">*</span></label>
