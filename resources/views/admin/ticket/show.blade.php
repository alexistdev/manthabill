...
@section('content')
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6"><h1>Detail Ticket</h1></div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('admin.tickets.inbox') }}">Ticket</a></li>
                            ...
                            <div class="timeline-item">
                                ...
                                @if($ticket->is_adm !== 1)
                                    ...
                                    <h3 class="timeline-header">
                                        <span class="text-primary fw-bold">{{ $pengirim }}</span>
                                        &mdash;
